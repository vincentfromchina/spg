...
public class BindActivity extends Activity
{
	...
	private void Bindphone()
	{
		...
		{
			Toast.makeText(BindActivity.this, "请输入设备号（不能超过10位字符）", Toast.LENGTH_LONG).show();
			return;
		}
		    ...
		    HttpEntity mHttpEntity;
		 		    ...
		 		    try
		 			{
						...
						try
						{
							...
							{
							case "0":
								Toast.makeText(BindActivity.this, "绑定成功", Toast.LENGTH_LONG).show();
								TextView tv2 = (TextView)findViewById(R.id.backinfo);
								tv2.setText("绑定成功");
								break;
							case "4":
								Toast.makeText(BindActivity.this, "设备已绑定", Toast.LENGTH_LONG).show();
							    tv2 = (TextView)findViewById(R.id.backinfo);
								tv2.setText("设备已绑定");
								break;
							case "2":
								Toast.makeText(BindActivity.this, "设备号不存在请重新输入\n如未注册请在设备上安装防走丢客户端后注册", Toast.LENGTH_LONG).show();
								 tv2 = (TextView)findViewById(R.id.backinfo);
								tv2.setText("设备号不存在请重新输入\n如未注册请在设备上安装防走丢客户端后注册");
								break;
							case "3":
								Toast.makeText(BindActivity.this, "已达到免费绑定数量上限", Toast.LENGTH_LONG).show();
								 tv2 = (TextView)findViewById(R.id.backinfo);
								tv2.setText("已达到免费绑定数量上限");
								break;
							default:
								Toast.makeText(BindActivity.this, "绑定失败", Toast.LENGTH_LONG).show();
								 tv2 = (TextView)findViewById(R.id.backinfo);
								tv2.setText("绑定失败");
								break;
							} 

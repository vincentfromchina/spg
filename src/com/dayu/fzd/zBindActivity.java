...
public class zBindActivity extends Activity
{
	...
	private void Bindphone()
	{
		...
		{
			Toast.makeText(zBindActivity.this, "请输入设备号（不能超过10位字符）", Toast.LENGTH_LONG).show();
			return;
		}
		    ...
		    HttpEntity mHttpEntity;
		 		    ...
		 		    try
		 			{
						...
						try
						{
							...
							{
							case "0":
								Toast.makeText(zBindActivity.this, "绑定成功", Toast.LENGTH_LONG).show();
								break;
							case "4":
								Toast.makeText(zBindActivity.this, "设备已绑定", Toast.LENGTH_LONG).show();
								break;
							case "2":
								Toast.makeText(zBindActivity.this, "设备号不存在请重新输入\n如未注册请注册", Toast.LENGTH_LONG).show();
								break;
							case "3":
								Toast.makeText(zBindActivity.this, "已达到免费绑定数量上限", Toast.LENGTH_LONG).show();
								break;
							default:
								Toast.makeText(zBindActivity.this, "绑定失败", Toast.LENGTH_LONG).show();
								break;
							} 

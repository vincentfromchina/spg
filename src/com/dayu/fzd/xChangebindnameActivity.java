...
public class xChangebindnameActivity extends Activity
{
			...
			//	img1.setImageResource(Integer.valueOf(TraceActivity.piclist[i]));
				...
				img1.setOnClickListener(new OnClickListener()
				{
					...
					public void onClick(View v)
					{
						...
						Intent mIntent = new Intent();
						mIntent.putExtras(bundle);
						mIntent.setClass(xChangebindnameActivity.this, BindpicActivity.class);
						startActivityForResult(mIntent, REQUEST_BINDPIC);
					}
				});
    ...
    private Boolean updatebindinfo(int id)
    {
    	 ...
    	 HttpClient mHttpClient = new DefaultHttpClient();
		   ...
		   String uri = serverurl+"/Updatebindinfo";
			...
			{
				Toast.makeText(xChangebindnameActivity.this, "请输入别名（不能超过12位字符）", Toast.LENGTH_LONG).show();
				return false;
			}
			...
			try
			{
				...
				if (mhttpResponse.getStatusLine().getStatusCode()==200)
				{
					...
					try
					{
						...
						{
						case "0":
							Toast.makeText(xChangebindnameActivity.this, "修改成功", Toast.LENGTH_LONG).show();
							break;
						case "3":
							Toast.makeText(xChangebindnameActivity.this, "修改失败，无此设备", Toast.LENGTH_LONG).show();
							break;
						
						default:
							Toast.makeText(xChangebindnameActivity.this, "修改失败", Toast.LENGTH_LONG).show();
							break;
						} 
			...
			} catch (IOException | JSONException e)
			{
				// TODO Auto-generated catch block
				e.printStackTrace();
				Toast.makeText(xChangebindnameActivity.this, "修改失败，请重试", Toast.LENGTH_LONG).show();
				return false;
			}

...
public class ExpWebActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_expweb);
		...
		Button btn_daijinquan = (Button)findViewById(R.id.btn_daijinquan);
		btn_daijinquan.setOnClickListener(new OnClickListener()
		{
			...
			{
				Intent web = new Intent();
				web.setClass(ExpWebActivity.this, CardpwdActivity.class);
